...
_G.packer_plugins = {
  ...
  vimwiki = {
    config = { "\27LJ\2\nì\5\0\0\3\0\4\0\t6\0\0\0009\0\1\0'\2\2\0B\0\2\0016\0\0\0009\0\1\0'\2\3\0B\0\2\1K\0\1\0Mlet g:vimwiki_valid_html_tags = 'b,i,s,u,sub,sup,kbd,br,hr, pre, script'ó\4\t\t\tlet g:vimwiki_list = [\n\t\t\t\t\\ \t{ 'path'               : '$HOME/SYCvimwiki',\n\t\t\t\t\\     'index'              : 'README',\n\t\t\t\t\\     'auto_toc'           : 1,\n\t\t\t\t\\ \t  'path_html'          : '$HOME/SYCvimwiki/html_site/',\n\t\t\t\t\\     'template_path'      : '$HOME/SYCvimwiki/templates/',\n\t\t\t\t\\ \t  'template_default'   : 'def_template',\n\t\t\t\t\\     'template_ext'       : '.html',\n\t\t\t\t\\     'nested_syntaxes'    : {'python': 'py', 'c++': 'cpp', 'yaml': 'yaml' },\n\t\t\t\t\\     'auto_tags'          : 1,\n\t\t\t\t\\     'auto_diary_index'   : 1,\n\t\t\t\t\\     'auto_generate_links': 1,\n\t\t\t\t\\     'auto_generate_tags' : 1,\n\t\t\t\t\\   },\n\t\t\t\t\\ ]\n\t\t\t\bcmd\bvim\0" },
    loaded = true,
